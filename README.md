# quarkus-smallrye-kafka-consumer-reproducer
...
You can then execute your native executable with: `./target/quarkus-smallrye-kafka-consumer-reproducer-1.0.0-SNAPSHOT-runner`
